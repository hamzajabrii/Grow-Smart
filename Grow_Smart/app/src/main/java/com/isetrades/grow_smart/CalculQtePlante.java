...
public class CalculQtePlante extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calcul_qte_plante);
       ...
       try
        {
            ...
            LISTP.enqueue(new Callback<List<Plante>>() {
                ...
                public void onResponse(Response<List<Plante>> response, Retrofit retrofit)
                {
                    ...
                    adapter = new ArrayAdapter<String>(CalculQtePlante.this, android.R.layout.simple_spinner_dropdown_item, listePlante);
                ...
                public void onFailure(Throwable t) {
                    ...
                    Toast.makeText(CalculQtePlante.this, "Erreur \t" + t.getLocalizedMessage(), Toast.LENGTH_LONG).show();
                }
            });
